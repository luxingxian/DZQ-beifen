  ...
  <qui-page :data-qui-theme="theme" class="content">
    <view v-if="loaded">
      ...
      <uni-popup ref="commentPopup" type="bottom" class="comment-popup-box">
				<view class="comment-popup" v-if="commentPopupStatus" :style="{bottom:textbottom+'rpx'}" >
      ...
      threadAction
        .then(data => {
					if(data.firstPost.images.length>0) {
					      this.headerImg=data.firstPost.images[0].url;
					 }
					
					 if(data.firstPost.contentHtml){
					    this.subTitle=data.firstPost.contentHtml;
      ...
      this.cursor = e.detail.cursor;
		...
		keyboardheightchange(e){
			if(e.detail.height>10){
				this.textbottom=174;//提交Btn100+输入框下边距30+poptop44
			}else {
				this.textbottom=0;
			}
		},
