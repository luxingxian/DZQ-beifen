<template>
  <view ref="themeCount" class="themeCount" v-if="!isDeleted" @click="cancel">
    <!-- <image
      class="addFine"
    ...
    <view class="themeItem" @click="backgroundClick">
      <view class="themeItem__header" @click="headClick" @click.stop="">
        <view class="themeItem__header__img">
          <qui-avatar :user="{ avatarUrl: themeImage, username: userName }" :is-real="isReal" size="70" />
        </view>
      ...
      <view class="themeItem__footer" @click.stop="">
        <view v-if="themeType === '1'" class="themeItem__footer__themeType1">
          ...
          <view
            ...
            @click="commentClick"
          >
					<qui-icon class="qui-icon" name="icon-comments" size="28" ></qui-icon>
            {{ t.comment }}
          ...
          >
            <qui-icon class="qui-icon" name="icon-share1" size="28" color="#AAA"></qui-icon>
            {{ t.share }}
          </view>
        </view>
